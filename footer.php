	...
	<footer class="site-footer" id="colophon">
		<div class="site-info">
			<div class="row justify-content-center">
				...
				<div class = "col-sm-5">
					<span class = "footerLink pull-right"><a href = "<?php echo bloginfo('url'); ?>/terms-and-conditions">Terms & Conditions</a> | <a href = "<?php echo bloginfo('url'); ?>/privacy-policy">Privacy Policy</a></span>
				</div>
			</div><!-- row end -->
		</div><!-- .site-info -->
	</footer><!-- #colophon -->
